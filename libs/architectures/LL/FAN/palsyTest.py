...
images_list = glob.glob("/media/gary/SAMSUNG/Uni/Datasets/Facial_Palsy_Images/IET_subset/*.jpg")
...
for i in images_list:
    ...
    st = i.split("/")
    filename = st[8].split(".")[0]
    
    savename = "/media/gary/SAMSUNG/Uni/Datasets/Facial_Palsy_Images/IET_subset" + '/' + filename + "2dlms.mat"        
    mat.savemat(savename, mdict={'finelms': preds})
